...
static const double d          = 6.75; // 6.5 for old bot distance between wheels in cm for new bot
...
static const double vwmax      = 400; // 200cm/s^2
static const double vsat       = ticksToCmS*150.; // 100 cm/s
